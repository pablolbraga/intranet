    ...
    public function buscarDadosPorEvolucao($idevolucao){
        ...
        $sql = "
                SELECT
                    ...
                    TO_CHAR(EVO.STARTDATE, 'DD/MM/YYYY HH24:MI:SS') AS DATAINICIOEVO,
                    TO_CHAR(EVO.ENDDATE, 'DD/MM/YYYY HH24:MI:SS') AS DATAFIMEVO, 
                    ASS.ASS_PAC, 
                    ASS.ASS_PROF, 
                    ...
                    (
                        SELECT SC.CODENAME FROM SCCCODE SC WHERE SC.ID = EVO.SCSPECIALITY 
                    ) AS NMESPECIALIDADE, 
                    AC.* 
                FROM 
                    TDACESPECIALIDADE AC 
