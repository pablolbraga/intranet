        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                <div class="sidebar-header">
                    <h3>Saúde Residence</h3>
                </div>

                <a href="index.php?pag=0" class="btn btn-primary dropdown-toggle" style="width: 100%; text-align: left;">Principal</a>

                <div class="dropdown">
                    <button class="btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="width: 100%; text-align: left;">
                        Dropdown button
                    </button>
